...
const WhatsAppButton = () => (
  <a
    href="https://wa.me/919325940584"
    target="_blank"
    rel="noopener noreferrer"
    className="fixed bottom-24 md:bottom-8 right-4 md:right-8 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-[0_10px_20px_-5px_rgba(37,211,102,0.5)] border-2 border-white hover:bg-[#128C7E] hover:scale-110 hover:-translate-y-1 transition-all duration-300"
