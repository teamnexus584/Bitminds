        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button 
              ...
              className="px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-all font-medium text-sm hover:scale-105 transform duration-200 shadow-lg hover:shadow-xl"
            >
              Get Started
            </button>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 border-t border-border animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="flex flex-col gap-3 mt-4">
              {navLinks.map((link) => (
                link.type === "link" ? (
                  ...
                  <button
                    key={link.href}
                    onClick={link.onClick}
                    className="px-4 py-2 text-foreground hover:bg-primary/10 hover:text-primary transition-colors rounded-lg text-left"
                  >
                    {link.label}
                  </button>
                )
              ...
              <button 
                onClick={handleContactClick}
                className="px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-all font-medium w-full"
              >
                Get Started
              </button>
            </div>
